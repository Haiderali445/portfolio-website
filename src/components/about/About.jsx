...
import "../../styles/prism-vsc-dark-plus.css"; // You'll need this CSS file
      ...
      <div className="container mx-auto max-w-7xl px-6">
        ...
        <div className="grid grid-cols-1 items-stretch gap-8 lg:grid-cols-2">
          ...
          <div className="group relative flex h-full">
            ...
            <div className="relative flex w-full flex-col items-center justify-between rounded-[2.5rem] border border-white/[0.08] bg-white/[0.03] p-6 text-center backdrop-blur-xl transition-all duration-500 hover:border-white/[0.14] hover:shadow-2xl hover:shadow-primary/15 md:p-8">
              <div className="flex flex-col items-center">
                <div className="relative mb-4 flex justify-center">
                  <div className="h-32 w-32 shrink-0 aspect-square overflow-hidden rounded-full border border-white/10 bg-white/5 shadow-2xl transition-transform duration-500 group-hover:scale-[1.03] md:h-40 md:w-40 relative">
                    <div className="absolute inset-0 animate-pulse bg-white/10" id="image-skeleton" />
                    <div className="absolute inset-0 z-10 rounded-full bg-gradient-to-tr from-primary/10 to-purple-500/10 mix-blend-overlay pointer-events-none" />
                    <img
                ...
                <div className="mb-4">
                  ...
                  {personalData.availabilityLabel && (
                    <div className="mt-3 flex justify-center">
                      <div className="inline-flex items-center gap-2 rounded-full border border-primary/15 bg-primary/[0.06] px-3 py-1 font-mono text-[10px] uppercase tracking-wider text-white/60">
                ...
                <div
                  className="max-w-md text-justify text-xs leading-relaxed text-text-muted md:text-sm"
          ...
          <div className="flex h-full flex-col gap-6">
            <div className="overflow-hidden rounded-2xl border border-[#2d2d2d] bg-[#1e1e1e] shadow-2xl shadow-black/30">
              <div className="flex items-center justify-between border-b border-[#2d2d2d] bg-[#181818] px-4 py-3">
                <div className="flex items-center gap-2">
                  ...
                  <div className="ml-4 flex items-center gap-1 rounded-md bg-[#252526] p-0.5 border border-[#333]">
                    <button
                      type="button"
                      onClick={() => setEditorMode("json")}
                      className={`flex items-center gap-1.5 rounded px-2.5 py-1 font-mono text-[10px] transition-all ${
                        editorMode === "json"
                          ? "bg-[#1e1e1e] text-[#4ec9b0] shadow-sm"
                    ...
                    <button
                      ...
                      className={`flex items-center gap-1.5 rounded px-2.5 py-1 font-mono text-[10px] transition-all ${
                        editorMode === "ide"
                          ? "bg-[#1e1e1e] text-[#ce9178] shadow-sm"
                          : "text-[#858585] hover:text-[#d4d4d4]"
                      }`}
                    >
                      <FaTerminal size={10} />
