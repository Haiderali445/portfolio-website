          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {relatedProjects.map((project, index) => (
              <motion.article
                ...
                className="group rounded-3xl overflow-hidden border border-white/10 bg-white/[0.03] hover:bg-white/[0.06] hover:border-white/20 transition-all duration-500"
              >
                {" "}
                {project.images?.[0] && (
