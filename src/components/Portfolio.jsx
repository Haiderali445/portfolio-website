...
const projects = [
  {
    ...
    description:
      "A full-featured Point of Sale system built with the MERN stack, offering inventory, billing, and reporting functionalities.",
    link: "", // No live link provided for POS
    github: "https://github.com/Haiderali445/mern-pos",
    image:
      "https://cdn.pixabay.com/photo/2017/05/10/17/45/pos-2308044_1280.jpg", // Image for POS project
  },
  {
    title: "My Blog",
    description:
      "A personal blogging website showcasing my articles, powered by Vite and React.",
    link: "https://haideraliblog.netlify.app/",
    github: "https://github.com/Haiderali445/portfolio-website",
    image:
      "https://cdn.pixabay.com/photo/2015/01/08/18/29/startup-593341_1280.jpg", // Image for Blog project
  },
];
      ...
      >
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-white text-sm flex items-center gap-2 opacity-80 group-hover:opacity-100 transition">
              <svg
