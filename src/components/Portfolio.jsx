...
const projects = [
  {
    ...
    image: 'https://cdn.pixabay.com/photo/2017/05/10/17/45/pos-2308044_1280.jpg',
  },
  {
    title: 'My Blog',
    ...
    image: 'https://cdn.pixabay.com/photo/2015/01/08/18/29/startup-593341_1280.jpg',
  },
];
          ...
          >
            <div className="flip-card w-full h-full bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="flip-card-inner h-full">
                <div className="flip-card-front bg-cover bg-center text-white p-6" style={{ backgroundImage: `url(${project.image})` }}>
                  <h3 className="text-xl font-semibold bg-black bg-opacity-50 p-2 rounded">{project.title}</h3>
                </div>
